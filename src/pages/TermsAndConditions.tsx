  ...
  return (
    <div className="py-4 px-6 md:px-32 lg:px-72 p-parent">
      ...
      <p className='text-x text-gray-600 '>
        ...
        páginas web y sitios móviles que integran el sitio www.findkoble.com (en lo
      ...
      <p className='text-x text-gray-600 '>
        ...
        Posesión de los Particulares, su Reglamento y los lineamientos
        aplicables.
      </p>
      <p className='text-x text-gray-600 '>
      ...
      <p className='text-x text-gray-600 '>
        DESARROLLOS KHOBLE, SAPI DE CV (en lo sucesivo denominado “Koble”)
      ...
      <p className='text-x text-gray-600 '>
        Los Usuarios podrán elegir entre los servicios ofertados en el Sitio, en
        el entendimiento de que sus datos personales estarán protegidos y se
      ...
      <p className='text-x text-gray-600 '>
        ...
        encriptación de datos y políticas internas de acceso a la información.
      </p>
      <p className='text-xl text-gray-800 font-semibold text-center'>
        Datos Personales Recolectados
      </p>
      <p className='text-x text-gray-600 '>
        Los datos personales que serán recolectados al utilizar el Sitio o al
        completar los formularios publicados en el mismo son los siguientes:
      </p>
      <p className='text-x text-gray-600 text-bold'>
        Información para registrarse como candidato:
      </p>
      <ol className='list-decimal list-inside text-gray-600'>
        <li>Nombre completo</li>
        <li>Dirección de correo electrónico </li>
        <li>Domicilio ( estado, ciudad y código postal) </li>
        <li>Fecha de nacimiento oficial para comprobar su identidad </li>
        <li>Información de contacto (número teléfono o celular) </li>
        <li>
          Información académica (instituciones, títulos, certificaciones){' '}
        </li>
        <li>Experiencia laboral (empleadores previos, puestos,</li>
        fechas de empleo)
        <li>Aptitudes, capacidades e intereses </li>
        <li>Fotografía (si es necesario y con consentimiento del titular) </li>
        <li>Curriculum Vitae (en formato PDF o imagen)</li>
      </ol>
      <p className='text-x text-gray-600 text-bold'>
        Información para registrarse como reclutador:
      </p>
      <ol className='list-decimal list-inside text-gray-600'>
        <li>Nombre completo</li>
        <li>
          Denominación social y nombre comercial de la empresa que representa
        </li>
        <li>Dirección de correo electrónico</li>
        <li>
          Información de contacto del representante (número de teléfono o
          celular)
        </li>
        <li>Domicilio (incluyendo estado, ciudad y código postal)</li>
        <li>Registro Federal de Contribuyentes (RFC)</li>
        <li>
          Documentación de la empresa (acta constitutiva, escritura pública que
          contenga los poderes de representación del representante, comprobante
          de domicilio)
        </li>
        <li>
          Información sobre la(s) vacante(s) que desea publicar (puesto,
          descripción, requisitos, salario, prestaciones, ubicación)
        </li>
        <li>Giro o sector al que pertenece la empresa</li>
        <li>Datos de facturación</li>
        <li>
          Información financiera (información sobre la tarjeta de crédito o
          débito a través de la cual realizarán los pagos por el servicio)
        </li>
      </ol>
      <p className='text-x text-gray-600 '>
      ...
      <p className='text-x text-gray-600 '>
        Los datos personales que se recolecten serán utilizados únicamente para
        los siguientes fines: Acreditación de la identidad del candidato o
        reclutador, Publicación de vacantes dentro del Sitio Creación de
        perfiles de candidato o reclutador, Integrar expedientes, bases de datos
        y sistemas Brindar asesoría personalizada, Gestionar y administrar el
        proceso de reclutamiento y selección de candidatos, Legitimar las
        operaciones de los usuarios y verificar sus datos, Cumplimiento de los
        servicios contratados por los reclutadores, Brindar atención a las
        solicitudes de información, quejas o reclamaciones de los usuarios
        Evaluar y mejorar la atención al cliente, Comunicar vacantes por medios
        electrónicos, Ofrecer recomendaciones a los reclutadores, Ofrecer
      ...
      <p className='text-xl text-gray-800 font-semibold text-center'>
        Instrumentos para Limitar el Uso o Divulgación de los Datos Personales
      </p>
      <p className='text-x text-gray-600 '>
        ...
        proporcione la información solicitada, la solicitud se entenderá como no
        presentada.
      </p>
      ...
      <p className='text-x text-gray-600 '>
        Los Usuarios podrán ejercer cualquiera de los derechos de acceso,
        rectificación, cancelación u oposición (“Derechos ARCO”) así como
        revocar su consentimiento para el tratamiento de sus datos personales
        enviando un correo a: (correo de contacto). Su petición deberá ir
        acompañada de la siguiente información: i) Nombre completo, ii)
        Documento de identificación oficial para comprobar su identidad; iii)
        ...
        la recepción de la solicitud. El Usuario tendrá 5 (cinco) días hábiles
        para proporcionar la información solicitada, en el supuesto de que no se
        proporcione la solicitud se entenderá como no presentada.
      </p>
      ...
      <p className='text-x text-gray-600 '>
        ...
        ciertos datos de los Usuarios, tales como: preferencia en la
        visualización de páginas web, nombre, contraseñas, dirección IP,
        domicilio y fecha en que se visitó la página. El Usuario puede
        deshabilitar o ajustar el uso de cookies, web beacons y otras
        tecnologías de rastreo en la configuración de su navegador.{' '}
      </p>
      ...
      <p className='text-x text-gray-600 '>
        El Usuario acepta los términos del Aviso de Privacidad al utilizar el
        Sitio. Si el Usuario no está de acuerdo con dicho Aviso de Privacidad,
        no deberá proporcionar ninguna información personal ni utilizar los
        servicios ofertados en el Sitio. Si el usuario navega o utiliza los
        servicios del Sitio significa que ha leído, entendido y acordado los
        términos antes expuestos. Si el Usuario tiene alguna duda relacionada
        con el presente aviso de privacidad o la forma en que se manejan los
        datos personales, puede enviar un correo a: (correo de contacto).
      </p>
    </div>
  );
}
